package ru.dorjik.rest_js.models;
...
public class User {
    ...
    public User(String username, String password, String firstName, String secondName, Integer age, String email, Set<Role> roles) {
